...
const BrowseCategoryCard = ({ icon ,categoryName, categoryDesc}) => {
  ...
  return (
    <div className="group bg-[#eeeeee] mx-auto lg:justify-between rounded-lg pt-10 px-5 w-[300px] md:w-[350px] lg:w-[500px] xl:w-[310px] text-center hover:bg-[#65bc7b] transition-colors duration-300 ease-in-out">
